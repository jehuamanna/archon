...
function parentMapFromRows(rows: WpnNoteRow[]): Map<string, string | null> {
...
function buildChildMap(rows: WpnNoteRow[]): Map<string | null, string[]> {
...
/**
 * Returns a deep-copied child map after a move (same project). Caller persists to DB.
 */
